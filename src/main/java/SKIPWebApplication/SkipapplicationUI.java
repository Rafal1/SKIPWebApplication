...
public class SkipapplicationUI extends UI {
    ...
    private MenuBar createTestMenu() {
        ...
        MenuItem mainItem = testMenu.addItem("Menu", null);
    ...
    private void initAddRemoveButtons() {
        addNewDriverButton.addClickListener(new ClickListener() {
        ...
        removeDriverButton.addClickListener(new ClickListener() {
            public void buttonClick(ClickEvent event) {
