...
public class EditVehicleWindow extends Window {
    ...
    public EditVehicleWindow(Table driversList) {
        ...
        fieldBRAND.setValue((String) driversList.getContainerProperty(driversList.getValue(), VehicleView.BRAND).getValue());
        ...
        fieldCOLOUR.setValue((String) driversList.getContainerProperty(driversList.getValue(), VehicleView.COLOUR).getValue());
        ...
        fieldMAX_LOAD.setValue((String) driversList.getContainerProperty(driversList.getValue(), VehicleView.MAX_LOAD).getValue());
        ...
        fieldREGISTRATION_NR.setValue((String) driversList.getContainerProperty(driversList.getValue(), VehicleView.REGISTRATION_NR).getValue());
        ...
        changeDriver.addClickListener(new Button.ClickListener() {
            ...
            public void buttonClick(Button.ClickEvent event) {
                ...
                veh.setTruckload((Integer) fields.getField(VehicleView.MAX_LOAD).getValue());
